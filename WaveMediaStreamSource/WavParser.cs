...
namespace WaveMSS
{
    ...
    public class WavParser : RiffParser
    {
        ...
        public void ParseWaveHeader()
        {
            ...
            // of the buffer.
            duration = waveFormat.AudioDurationFromBufferSize(Chunk.Size);
        }
        ...
        private void ReadFormatBlock()
        {
            try
            {
                ...
                Debug.Assert(waveFormat == null, "The waveformat structure should have been set before");
                ...
                waveFormat.SetFromByteArray(data);
            }
            catch (Exception)
            {
                waveFormat = null;
